...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url('musnah/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" id="keterangan" name="keterangan">
                                ...
                                <option value="2" <?= (old('keterangan') == 2) ? 'selected' : ''; ?>>Dijual</option>
                                <option value="1" <?= (old('keterangan') == 1) ? 'selected' : ''; ?>>Barang Rusak</option>
                                <option value="0" <?= (old('keterangan') == 0) ? 'selected' : ''; ?>>Tidak Layak Pakai</option>
                            </select>
                            <div class="invalid-feedback">

 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
     <div class="sidenav-header ">
         ...
         <a style="text-align: left;" class="navbar-brand " href="<?= base_url() ?>" target="_blank">
             <img src="<?= base_url() . '/assets/img/upload/' . $data['logo'] ?>" class="navbar-brand-img h-100" alt="main_logo">
             <span class="ms-1 font-weight-bold ">
                 <!-- get data from database web -->
     ...
     <ul class="navbar-nav" id="sidenav-collapse-main">
         ...
         <li class="nav-item">
         <li class="nav-item">
             <a class="nav-link <?= ($act == 'item') ? ' active' : ''; ?>" href="<?= base_url('item') ?>">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                     <!-- arrow icon -->
                     <i style="color:black;" class="fa fa-hourglass" aria-hidden="true"></i>
         ...
         <li class="nav-item">
             <a class="nav-link <?= ($act == 'supply') ? ' active' : ''; ?>" href="<?= base_url('supply') ?>">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                     <!-- arrow icon -->
                     <i style="color:black;" class="fa fa-hourglass" aria-hidden="true"></i>
         ...
         <li class="nav-item">
             <a class="nav-link <?= ($act == 'export') ? ' active' : ''; ?>" href="<?= base_url('export') ?>">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                     <!-- arrow icon -->
                     <i style="color:black;" class="fa fa-hourglass" aria-hidden="true"></i>
         ...
         <li class="nav-item">
             <a class="nav-link <?= ($act == 'report') ? ' active' : ''; ?>" href="<?= base_url('report') ?>">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                     <!-- arrow icon -->
                     <i style="color:black;" class="fa fa-hourglass" aria-hidden="true"></i>
         ...
         <?php if (session()->get('level') == 'Admin') { ?>
             <li class="nav-item">
                 <a class="nav-link <?= ($act == 'settings') ? ' active' : ''; ?>" href="<?= base_url('settings') ?>">
                     <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
             ...
             <li class="nav-item">
                 <a class="nav-link <?= ($act == 'administrator') ? ' active' : ''; ?>" href="<?= base_url('users') ?>">
                     <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
